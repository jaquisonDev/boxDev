...
import iconComp from '../assets/empresa.png';
        ...
        <div>
            ...
            <C.ContainerExpenseEx>
                ...
                <C.AreaLogo secondary>
                    ...
                    <img src={iconComp} alt="" width={300}/>
                ...
                <C.FormularyEx onSubmit={e => e.preventDefault()}>
                    <C.Title>
                        Empresas
                        <img src={iconComp} alt="icone do titulo" width={50}/>
                    </C.Title>

                    <C.Inputs type='text' placeholder='Nome fantasia...'/>
                    <C.Inputs type='text' placeholder='Produto(descrição - opcional)...'/>
